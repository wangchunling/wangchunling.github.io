;(function (root, factory) {
  ...
  var module = angular.module('airsliderModule', []).factory('airRzSliderOptions', function () {
    ...
    slider.prototype = {
      ...
      dropEvent: function() {
        this.outerCircle.removeEventListener('touchstart', this.clickStar.bind(this))
        this.outerCircle.removeEventListener('touchmove', this.clickInit.bind(this))
        this.outerCircle.removeEventListener('touchend', this.clickEnd.bind(this))

        this.innerCircle.removeEventListener('touchstart', this.clickStar.bind(this))
        this.innerCircle.removeEventListener('touchmove', this.clickInit.bind(this))
        this.innerCircle.removeEventListener('touchend', this.clickEnd.bind(this))


        this.handler.removeEventListener('touchstart', this.touchstart.bind(this));
        this.handler1.removeEventListener('touchstart', this.touchstart.bind(this));
      ...
      clickStar: function (event) {
        console.log(this.scope.disabled, this.options.disabled)
        ...
        if (edAng >= sxAng && pontAng >= sxAng && pontAng <= edAng) {
          ...
          console.log(this.lock.flag ? 'max' : 'min', '1')
          ...
          console.log(this.lock.flag ? 'max' : 'min', '2')
          //this.clickHandle(result)
          // return false
          ...
          console.log(this.lock.flag ? 'max' : 'min', '3')
          //this.clickHandle(result)
          // return false
        }
        ...
        if (edR && stR) {
          ...
          console.log(this.lock.flag ? 'max' : 'min', '动')
          console.log('都在左侧')
        } else if (edL && stL) {
