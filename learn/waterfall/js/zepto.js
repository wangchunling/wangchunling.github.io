(function() {
    ...
    define("zepto", [], function(require, exports, module) {
        ...
        mods = [];
        require.get = require;
        return typeof curr === "function" ? curr.apply(this, 
        arguments) : require
    });
...
define.pack("./core", [], function(require, exports, module) {
    ...
    zepto.init = function(selector, context) {
        if (!selector)
            ...
            if (isArray(selector))
                ...
                dom = 
                [isPlainObject(selector) ? $.extend({}, selector) : selector], selector = null;
    ...
    zepto.qsa = function(element, selector) {
        var found;
        return isDocument(element) && idSelectorRE.test(selector) ? (found = 
        element.getElementById(RegExp.$1)) ? [found] : [] : element.nodeType !== 1 && element.nodeType !== 9 ? [] : slice.call(classSelectorRE.test(selector) ? element.getElementsByClassName(RegExp.$1) : tagSelectorRE.test(selector) ? element.getElementsByTagName(selector) : element.querySelectorAll(selector))
    };
    ...
    function deserializeValue(value) {
        var num;
        try {
            return value ? value == "true" || (value == "false" ? false : value == "null" ? null : !isNaN(num = Number(value)) ? num : /^[\[\{]/.test(value) ? $.parseJSON(value) : 
            value) : value
        } catch (e) {
            return value
        }
    ...
    $.screen = {width: screen.width * (window.devicePixelRatio || 1),height: screen.height * (window.devicePixelRatio || 1),ratio: window.devicePixelRatio || 1};
    $.fn = {forEach: emptyArray.forEach,reduce: emptyArray.reduce,push: emptyArray.push,sort: emptyArray.sort,indexOf: emptyArray.indexOf,
        concat: emptyArray.concat,map: function(fn) {
            ...
            return idx === 
            -1 ? this.slice(idx) : this.slice(idx, +idx + 1)
        },first: function() {
            var el = this[0];
            ...
            if (this[0] && !func)
                var dom = $(structure).get(0), clone = dom.parentNode || this.length > 
                1;
            ...
            this.length == 0 || this[0].nodeType !== 1 ? undefined : name == "value" && this[0].nodeName == "INPUT" ? this.val() : !(result = this[0].getAttribute(name)) && name in this[0] ? this[0][name] : result : this.each(function(idx) {
                if (this.nodeType !== 1)
                    return;
                if (isObject(name))
                    for (key in name)
            ...
            return value === 
            undefined ? this[0] && this[0][name] : this.each(function(idx) {
            ...
            if (coordinates)
                return this.each(function(index) {
                    var $this = 
                    $(this), coords = funcArg(this, coordinates, index, $this.offset()), parentOffset = $this.offsetParent().offset(), props = {top: coords.top - parentOffset.top,left: coords.left - parentOffset.left};
            ...
            if (type(property) == "string") {
                ...
                for (var key in property)
                    if (!property[key] && property[key] !== 0)
                        this.each(function() {
                            this.style.removeProperty(getCssPrefix(this, 
                            dasherize(key)))
                        });
                    else
        ...
        when) {
            ...
            return {top: offset.top - parentOffset.top,
    ...
    ["width", "height"].forEach(function(dimension) {
        ...
        $.fn[dimension] = function(value) {
            ...
            if (value === undefined)
                return isWindow(el) ? 
                el["inner" + dimensionProperty] : isDocument(el) ? el.documentElement["scroll" + dimensionProperty] : (offset = this.offset()) && offset[dimension];
            else
                return this.each(function(idx) {
                    el = $(this);
    ...
    adjacencyOperators.forEach(function(operator, operatorIndex) {
        ...
        $.fn[operator] = function() {
            var argType, nodes = $.map(arguments, 
            function(arg) {
                argType = type(arg);
            ...
            return this.each(function(_, target) {
                ...
                nodes.forEach(function(node) {
                    if (copyByClone)
                        ...
                        return $(node).remove();
                    traverseNode(parent.insertBefore(node, 
                    target), function(el) {
...
define.pack("./ie", ["./core"], function(require, exports, module) {
    ...
    if (!("__proto__" in {}))
        $.extend($.zepto, {Z: function(dom, selector) {
                dom = dom || [];
                $.extend(dom, $.fn);
                dom.selector = selector || "";
                return dom
...
define.pack("./ajax.z", ["./core"], function(require, exports, module) {
    ...
    function triggerGlobal(settings, 
    context, eventName, data) {
        if (settings.global)
    ...
    $.get = function(url, data, success, dataType) {
        return $.ajax(parseArguments.apply(null, 
        arguments))
    };
...
define.pack("./data.z", ["./core"], function(require, exports, module) {
    ...
    function setData(node, name, value) {
        var id = node[exp] || 
        (node[exp] = ++$.uuid), store = data[id] || (data[id] = attributeData(node));
        if (name !== undefined)
...
define.pack("./detect", ["./core"], function(require, exports, module) {
    ...
    function detect(ua) {
        ...
        uc = ua.match(/\s?UC|JUC|UCWEB/), qq = ua.match(/MQQBrowser\/([\d\.]+)/), xiaomi = ua.match(/MiuiBrowser\/([\d\.]+)/);
        ...
        if (ieMobile)
            browser.ieMobile = true, browser.version = ieMobile[1];
        if (safari && (ua.match(/Safari/) || 
        !!os.ios))
            browser.safari = true;
        if (webview)
...
define.pack("./event.z", ["./core", "./detect"], function(require, exports, module) {
    var $ = require("./core");
    require("./detect");
    var $$ = $.zepto.qsa, handlers = {}, _zid = 1, specialEvents = {}, hover = {mouseenter: "mouseover",mouseleave: "mouseout"};
    ...
    function eventFix(type) {
        if ($.browser.wechat) {
            ...
            if (version >= 4.2 && version <= 4.5) {
                ...
                if ((type.indexOf("tap") >= 
                0 || type.indexOf("swipe") >= 0) && type.indexOf("weixin-") == -1)
                    type = "weixin-" + type
            }
        }
        return type
    ...
    function realEvent(type) {
        if ($.browser.ie || $.browser.ieMobile)
            if (type == 
            "tap")
                type = "click";
    ...
    var returnTrue = function() {
        ...
        return false
    }, ignoreProperties = /^([A-Z]|layer[XY]$)/, eventMethods = {preventDefault: "isDefaultPrevented",stopImmediatePropagation: "isImmediatePropagationStopped",stopPropagation: "isPropagationStopped"};
        ...
        eachEvent(events, callback, function(event, callback) {
            ...
            if (!delegateEvent[event]) {
                ...
                add(document.body, event, callback, selector, function() {
                    return function(e) {
                        var evt = createProxy(e), match, node = e.target, dels = delegateEvent[e.type].slice(), result;
                        hasDelegate: while (true) {
                            for (var i = 0, data; data = dels[i]; i++)
                                if ($.contains(data.element, node)) {
                                    match = $.zepto.matches(node, 
                                    data.selector) ? node : null;
                                    if (match) {
                                        data.match = match;
                                        evt = $.extend(evt, {currentTarget: match,liveFired: data.element});
            ...
            self.each(function(i, element) {
                delegateEvent[event].push({element: element,
                    selector: selector,event: event,callback: callback})
            })
        });
        return this
    };
    $.fn.undelegate = function(selector, event, callback) {
        return this.each(function(i, element) {
            delegateEvent[event] = (delegateEvent[event] || []).filter(function(data) {
                return !(data.element == element && (!selector || data.selector == selector) && (!callback || data.callback == callback))
            })
        })
    };
    ...
    $.Event = function(type, props) {
        ...
        if (props)
            for (var name in props)
                name == "bubbles" ? bubbles = !!props[name] : 
...
define.pack("./fx", ["./core"], function(require, exports, module) {
    ...
    function dasherize(str) {
        return downcase(str.replace(/([a-z])([A-Z])/, 
        "$1-$2"))
    }
    ...
    cssReset[transitionProperty = prefix + "transition-property"] = cssReset[transitionDuration = prefix + "transition-duration"] = cssReset[transitionTiming = prefix + "transition-timing-function"] = 
    cssReset[animationName = prefix + "animation-name"] = cssReset[animationDuration = prefix + "animation-duration"] = cssReset[animationTiming = prefix + "animation-timing-function"] = "";
    $.fx = {off: eventPrefix === undefined && testEl.style.transitionProperty === undefined,speeds: {_default: 400,fast: 200,slow: 600},cssPrefix: prefix,transitionEnd: normalizeEvent("TransitionEnd"),animationEnd: normalizeEvent("AnimationEnd")};
    $.fn.animate = function(properties, duration, ease, callback) {
        if ($.isPlainObject(duration))
            ease = duration.easing, 
            callback = duration.complete, duration = duration.duration;
        if (duration)
            duration = (typeof duration == "number" ? duration : $.fx.speeds[duration] || $.fx.speeds._default) / 1E3;
...
define.pack("./touch", ["./core"], function(require, exports, module) {
    var $ = require("./core");
    var ghostClick = {_coordinates: [],_failOnPrevent: ["textarea", "input"],mark: function(x, y, el) {
            ...
            ghostClick._coordinates.forEach(function(coordinate) {
                ...
                var canPrevent = ghostClick._failOnPrevent.indexOf(event.target.nodeName.toLocaleLowerCase()) < 
                0;
    ...
    function swipeDirection(x1, x2, y1, y2) {
        ...
        return xDelta >= yDelta ? x1 - x2 > 0 ? "Left" : "Right" : y1 - 
        y2 > 0 ? "Up" : "Down"
    }
    function longTap() {
        longTapTimeout = null;
        ...
        $(document).ready(function() {
            ...
            $(document.body).bind("touchstart", function(e) {
                ...
                if (touch.isMove && touch.x2 && Math.abs(touch.x1 - touch.x2) < 5 && touch.y2 && Math.abs(touch.y1 - touch.y2) < 5)
                    littleMove = true;
                if (touch.x2 && Math.abs(touch.x1 - touch.x2) > 30 || touch.y2 && 
                Math.abs(touch.y1 - touch.y2) > 30)
...
define.pack("./ie.touch", ["./core"], function(require, exports, module) {
    ...
    if (!("ontouchstart" in document) && window.navigator.msPointerEnabled)
        $.each([{ie: "MSPointerDown",webkit: "touchstart"}, {ie: "MSPointerMove",webkit: "touchmove"}, {ie: "MSPointerUp",webkit: "touchend"}, {ie: "MSPointerCancel",webkit: "touchcancel"}], function(index, events) {
            $(document.body).on(events.ie, function(e) {
                if (e.type != "MSPointerUp" && e.type != "MSPointerCancel" && e.buttons == 0 && e.pointerType != e.MSPOINTER_TYPE_TOUCH)
                    return;
                if (e.target) {
                    var event = $.Event(events.webkit, {touches: [{pageY: e.pageY,pageX: e.pageX,clientX: e.clientX,clientY: e.clientY,screenX: e.screenX,screenY: e.screenY,target: e.target}]});
